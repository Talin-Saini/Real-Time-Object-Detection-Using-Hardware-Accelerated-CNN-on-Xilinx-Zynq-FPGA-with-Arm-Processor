...
set C_modelArgList {
	...
	{ weights8 int 64 regular {axi_slave 0}  }
	{ weights6 int 64 regular {axi_slave 0}  }
	{ weights4 int 64 regular {axi_slave 0}  }
	{ weights2 int 64 regular {axi_slave 0}  }
	{ output_r int 64 regular {axi_slave 0}  }
	{ Cin int 32 regular {axi_slave 0}  }
	{ Cout int 32 unused {axi_slave 0}  }
	{ H int 32 regular {axi_slave 0}  }
	{ W int 32 regular {axi_slave 0}  }
	{ precision int 32 regular {axi_slave 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "input_r","offset": { "type": "dynamic","port_name": "input_r","bundle": "control"},"direction": "READONLY"},{"cName": "weights8","offset": { "type": "dynamic","port_name": "weights8","bundle": "control"},"direction": "READONLY"},{"cName": "weights6","offset": { "type": "dynamic","port_name": "weights6","bundle": "control"},"direction": "READONLY"},{"cName": "weights4","offset": { "type": "dynamic","port_name": "weights4","bundle": "control"},"direction": "READONLY"},{"cName": "weights2","offset": { "type": "dynamic","port_name": "weights2","bundle": "control"},"direction": "READONLY"},{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "weights8", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} , 
 	{ "Name" : "weights6", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":40}, "offset_end" : {"in":51}} , 
 	{ "Name" : "weights4", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":52}, "offset_end" : {"in":63}} , 
 	{ "Name" : "weights2", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":64}, "offset_end" : {"in":75}} , 
 	...
 	{ "Name" : "Cin", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":88}, "offset_end" : {"in":95}} , 
 	{ "Name" : "Cout", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":96}, "offset_end" : {"in":103}} , 
 	{ "Name" : "H", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":104}, "offset_end" : {"in":111}} , 
 	{ "Name" : "W", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":112}, "offset_end" : {"in":119}} , 
 	{ "Name" : "precision", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":120}, "offset_end" : {"in":127}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"cnn_accelerator","role":"start","value":"0","valid_bit":"0"},{"name":"cnn_accelerator","role":"continue","value":"0","valid_bit":"4"},{"name":"cnn_accelerator","role":"auto_start","value":"0","valid_bit":"7"},{"name":"input_r","role":"data","value":"16"},{"name":"weights8","role":"data","value":"28"},{"name":"weights6","role":"data","value":"40"},{"name":"weights4","role":"data","value":"52"},{"name":"weights2","role":"data","value":"64"},{"name":"output_r","role":"data","value":"76"},{"name":"Cin","role":"data","value":"88"},{"name":"Cout","role":"data","value":"96"},{"name":"H","role":"data","value":"104"},{"name":"W","role":"data","value":"112"},{"name":"precision","role":"data","value":"120"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"cnn_accelerator","role":"start","value":"0","valid_bit":"0"},{"name":"cnn_accelerator","role":"done","value":"0","valid_bit":"1"},{"name":"cnn_accelerator","role":"idle","value":"0","valid_bit":"2"},{"name":"cnn_accelerator","role":"ready","value":"0","valid_bit":"3"},{"name":"cnn_accelerator","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set ArgLastReadFirstWriteLatency {
	cnn_accelerator {
		gmem {Type IO LastRead 75 FirstWrite 32}
		...
		Cout {Type I LastRead -1 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "17955", "Max" : "17955"}
	, {"Name" : "Interval", "Min" : "17956", "Max" : "17956"}
]}
