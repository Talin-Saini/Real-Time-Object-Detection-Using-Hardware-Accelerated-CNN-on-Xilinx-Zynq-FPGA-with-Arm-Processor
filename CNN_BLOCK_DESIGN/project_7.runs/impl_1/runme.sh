...
HD_PWD='C:/Users/ishan/ECT110/project_7/project_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_controler_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cnn_controler_wrapper.tcl -notrace
