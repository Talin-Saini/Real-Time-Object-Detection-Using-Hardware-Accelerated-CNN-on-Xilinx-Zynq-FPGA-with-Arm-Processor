...
HD_PWD='C:/Users/ishan/ECT110/project_7/project_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnn_controler_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnn_controler_wrapper.tcl
