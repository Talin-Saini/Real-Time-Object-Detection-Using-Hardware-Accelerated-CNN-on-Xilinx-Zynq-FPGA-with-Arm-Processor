...
#
# Script generated by Vivado on Tue Feb 17 17:06:58 +0530 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cnn_controler.sh
...
#
# Usage        : cnn_controler.sh
#                cnn_controler.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cnn_controler.sh [-reset_run]
#                cnn_controler.sh [-reset_log]
#                cnn_controler.sh [-help]
#
...
# script info
echo -e "cnn_controler.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cnn_controler.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cnn_controler.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cnn_controler.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cnn_controler.sh [-help]\n\
Usage: cnn_controler.sh [-step]\n\
Usage: cnn_controler.sh [-lib_map_path]\n\
Usage: cnn_controler.sh [-reset_run]\n\
Usage: cnn_controler.sh [-reset_log]\n\
Usage: cnn_controler.sh [-keep_index]\n\
Usage: cnn_controler.sh [-noclean_files]\n\n\
